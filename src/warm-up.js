...
var vegetables = ["zucchini", "squash", "cabbage", "leek", "scallion"];
...
// different fruits.
var fruits = ["tomato", "durian", "lychee", "orange", "jackfruit", "apple", "tangerine"];
...
// Other key value pairs that might make sense are location, hours, date founded, etc.


// Write the code to add the key of location, with the value of 'Orlando, Florida'. Use dot
// notation to do this. DO NOT modify your code from above.
groceryStore.location = "Orlando, Florida";
